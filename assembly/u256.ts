// Subset of u256 from @MaxGraey https://github.com/MaxGraey/as-bignum/blob/master/assembly/integer/u256.ts
// The Graph has many compatibility issues with importing as-bignum directly, so trimming this down to only the essential functionality
...
export class u256 {
  ...
  */
   ...
   * @param  T  is <bool | i8 | u8 | i16 | u16 | i32 | u32 | i64 | u64 | f32 | f64 | u256 | u8[] | Uint8Array | String>
   * @returns   type of T
   */
  @inline
  as<T>(): T {
